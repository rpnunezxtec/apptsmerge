<?PHP
// $Id: proc-piv-doccap.php 202 2009-03-16 02:52:57Z atlas $
...
{
	if ($mysession->testmprocmask(PMASK_PRPDOCCAP) === true)
	{
		...
		if ($dbh !== false)
		{
			...
			if ($wauth)
			{
				...
				if (strcasecmp($newstat, $oldstat) !== 0)
				{
					...
					// Add object logs
					$ologentry = "[PIV DOCCAP] Modified to ".$newstat." by ".$ologname." on ".$dt;
