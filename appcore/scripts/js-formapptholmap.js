			...
			for (var i=0;i<hml;i+=2)
			{
				...
				for (var j=0;j<8;j++)
				{
					...
					if (cell)
					{
						if (n&(1<<j))
						{
							if (cell.className=="cal_weekend")
								cell.className="cal_weekendselect";
							else if (cell.className=="cal_weekday")
								cell.className="cal_weekdayselect";
						}
						else
						{
							if (cell.className=="cal_weekendselect")
								cell.className="cal_weekend";
							else if (cell.className=="cal_weekdayselect")
								cell.className="cal_weekday";
						}
					}
					bitnum++;
				}
...
function cellprocess(id)
{
	...
	if (cell)
	{
		...
		else if (cell.className=="cal_weekendselect")
		{
			cell.className="cal_weekend";
