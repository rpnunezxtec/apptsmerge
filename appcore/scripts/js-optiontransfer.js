...
// -------------------------------------------------------------------
// selectAllOptionsRight(select_object_id)
//  This function selects all options from the right select box(in a 
//  multiple select object). This is used when passing values from 
// 	the left to the right select boxes. Select all options in the
//  right box before submitting the form so the values will be 
//  sent to the server.
// -------------------------------------------------------------------
function selectAllOptionsRight(id) {
	var element = document.getElementById(id);
	selectAllOptions(element);
	}
