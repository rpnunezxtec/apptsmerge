...
define("XCOPY_XMLFILE", "../../appconfig/pivi/carddef-usaccess-pivi.xml");

$localdir = ".";
$form_action = "create";
$xml_filename = "carddef-usaccess-pivi.xml";

define("XROOT_BRANCH", $ldap_authcred.",credentials=authentx,ounit=credentials,".$ldap_treetop);
define("TOKEN_BRANCH", $ldap_credentials.",ounit=credentials,".$ldap_treetop);								// used for soft cert

// Location of local CA Certificate
define("LOCALCACRT_PATH", "/authentx/app/certs/XTec_PIVI_SSP_Test_CA2_Content_Signer_Certificate1.der"); 			// location of signing cert to get dn
define("LOCALCAKEY_PATH", "file:///authentx/app/certs/XTec_PIVI_Test2_CA_1_Content_Signer_Certificate1.key"); 		// used for soft cert
...
$_status_check = "piviPending";
$ounit = "pivi";

$_rules_apply = false;

$_rulechecks = array(
"pivi" => array("photocap", "fpcap", "doccap"),
);
...
if (!defined("ET_PRINTING_PIVI"))
	define("ET_PRINTING_PIVI", "process_printing");
