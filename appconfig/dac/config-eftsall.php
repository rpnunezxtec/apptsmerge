...
//Flag to disable EFTS transmittals
$disabled = true;

$_cred_basedn = "credentials=dhs,credentials=authentx,ounit=credentials,dc=authentx";
$_token_basedn = "credentials=dhs,credentials=tokens,ounit=credentials,dc=authentx";
...
"entity:gcoid=general:xblk:002611:gco|T1_DAI.A.9|Destination Agency Identifier|txt:txt|0x00",
"entity:gcoid=general:xblk:002612:gco|T1_ORI.A.9|Originating Agency Identifier|txt:txt|0x00",
"entity:gcoid=general:xblk:00250c:gco|T1_TCN.A.40|Transaction Control Number|txt:txt|0x00",
"entity:gcoid=general:xblk:002614:gco|T2_RFP.A.75|Reason Fingerprinted|txt:txt|0x00",
"entity:gcoid=general:xblk:002615:gco|T2_ATN.A.30|Attention Indicator|txt:txt|0x00",
"entity:gcoid=general:xblk:00250b:gco|OPAC|opac|txt:txt|0x00",
"entity:gcoid=general:xblk:002617:gco|T1_TCR.A.40|Transmission Control Reference|txt:txt|0x00",
"entity:gcoid=general:xblk:002618:gco|T2_OCA.A.20|Originating Agency Case No|txt:txt|0x00",
"entity:gcoid=general:xblk:002619:gco|T1_TOT.A.4|Type of Transaction|txt:txt|0x00",
"entity:gcoid=general:xblk:00260a:gco|T2_TSR.A.1|Type of Search Requested|txt:txt|0x00",
"entity:gcoid=general:xblk:00260b:gco|T2_RET.A.1|Retention Code|txt:txt|0x00",
"entity:gcoid=general:xblk:00260c:gco|SEND_TYPE|Send Type|txt:txt|0x00",
...
"entity:bioid=L_Ring_CS:rem:biometric|CS_L_Ring_AMP|Card Scan Left Ring AMP|txt:txt|0x00",
"entity:bioid=L_Little_CS:rem:biometric|CS_L_Little_AMP|Card Scan Left Little AMP|txt:txt|0x00",
"entity:gcoid=general:xblk:00250d:gco|T2_IMA.A.100|IMA MAKE MODEL SERNO LOG|txt:txt|0x00",
);
...
"T1_NSR.A.5" => array ("Native Scanning Resolution" => "19.69"),
"T1_NTR.A.5" => array ("Nominal Transmitting Resolution" => "19.69"),
"T2_RAC.A.1" => array ("Race" => "U"),
);
