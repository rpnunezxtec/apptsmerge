...
//flags:
$admin_override = true;  // if you want to override the administrator, set this to true.  it will assume action=reqCerts.

$_db_elements = array (
"token:tokenclass:credential|tokenclass|Token Type|txt:txt|0x00",
"token:tokentype:credential|tokentype|Token Type|txt:txt|0x00",
