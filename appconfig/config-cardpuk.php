<?PHP
// $Id: config-initcard.php 660 2008-09-04 03:00:46Z atlas $
// Service configuration file
//    xsvc-reqcr.xas?id=tokenacid

require_once("../appconfig/config-app.php");
require_once("../appconfig/config-initcard.php");
require_once("../appconfig/config-keymaps.php");
...
$_service_envelope = "cardpukresult";
