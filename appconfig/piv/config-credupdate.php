...
define("XCOPY_XMLFILE", "../../appconfig/piv/carddef-usaccess-piv-update.xml");
...
//define("LOCALCACRT_PATH", "/authentx/app/certs/pivSigner.der"); 				// location of signing cert to get dn
//define("LOCALCAKEY_PATH", "file:///authentx/app/certs/private.pivSigner.key"); // used for soft cert
